...
const PostCard = ({ post }) => {
  ...
  return (
    <div className="bg-white shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8">
      ...
      <p className="text-center text-lg text-gray-750 font-normal px-4">
        {post.excerpt}
      </p>
      <div className="text-center">
        <Link href={`/post/${post.slug}`}>
          <span className="transition duration-500 transform hover:-translate-y-1 inline-block bg-blue-700 text-lg font-medium rounded-full text-white px-5 py-2 cursor-pointer">
            Continue Reading
          </span>
        </Link>
      </div>
